				...
				<p class="meta">
					<strong itemprop="author"><?php comment_author(); ?></strong> <?php
						...
						if ( get_option( 'woocommerce_review_rating_verification_label' ) === 'yes' )
							...
							if ( get_comment_meta( $comment->comment_ID, '_madison_review_from', true ) ) {
								echo '<em class="verified">(from ' . get_comment_meta( $comment->comment_ID, '_madison_review_from', true ) . ')</em> ';
							}
