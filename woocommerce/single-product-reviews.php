...
?>
<div class="mdl-cell mdl-cell--4-col mdl-cell--8-col-tablet mdl-cell--5-col-desktop mdl-grid npom madison-reviews">
	<div id="reviews" class="right mdl-cell mdl-cell--4-col mdl-cell--4-col-tablet mdl-cell--12-col-desktop mdl-card mdl-shadow--2dp">
		<div id="comments">
			...
			<div class="mdl-card__supporting-text child scrollable">
	...
	<div class="mdl-cell mdl-cell--4-col mdl-cell--4-col-tablet mdl-cell--12-col-desktop mdl-card mdl-shadow--2dp small-height">
		...
		<?php if ( get_option( 'woocommerce_review_rating_verification_required' ) === 'no' || wc_customer_bought_product( '', get_current_user_id(), $product->id ) ) : ?>
			...
			<div id="review_form_wrapper" class="mdl-card__supporting-text">
				<div id="review_form">
					<?php
